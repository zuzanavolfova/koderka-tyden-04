# Podklady pro 4. týden

Toto jsou podklady pro video lekce pro 4. týden online kurzu Staň se kóderkou od Czechitas.
...
4. Na příkazové řádce spusť příkaz `git clone adresa.git`. Místo `adresa.git` doplň adresu repozitáře, kterou sis z GitHubu zkopírovala v prvním kroku. Celý příkaz tak např. může vypadat takto:
   ```
   git clone https://github.com/Czechitas-Koderka-podklady/koderka-tyden-04.git
   ```

5. Ve tvé složce (u mě *KODERKA*) se vytvoří složka `koderka-tyden-04` a do ní se zkopírují všechny potřebné soubory.
